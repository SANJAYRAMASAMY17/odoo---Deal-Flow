...
const LoginPage = ({ setIsAuthenticated }) => {
  ...
  const fillDemoCredentials = () => {
    ...
    setEmail('arjun.mehta@dealflow.in');
    setPassword('BharatDealFlow#2026');
    setStatusMessage({ type: 'info', text: '✨ Indian Enterprise Demo credentials populated!' });
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      establishUserSession(authResult.user, rememberMe);
  ...
  const onSocialLogin = async (provider) => {
    ...
    try {
      ...
      establishUserSession(ssoResult.user, rememberMe);
        ...
        <div className="relative glass-card rounded-3xl p-8 sm:p-10 border border-slate-700/60 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Manage GST quotations, Indian B2B deals & revenue pipeline
            </p>
          </div>
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full py-2 px-3 rounded-xl bg-blue-600/10 hover:bg-blue-600/15 border border-blue-500/30 text-blue-300 hover:text-blue-200 text-xs font-medium flex items-center justify-center gap-2 transition-all group cursor-pointer"
            >
              <svg className="w-4 h-4 text-blue-400 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" />
              </svg>
              <span>Auto-fill Indian Enterprise Demo Account</span>
            </button>
          </div>
          ...
          {statusMessage && (
            <div
              className={`mb-6 p-3.5 rounded-xl text-xs font-medium border flex items-center gap-2.5 transition-all animate-fadeIn ${
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full py-3 pl-11 pr-4 rounded-xl glass-input text-sm placeholder-slate-500 outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  required
                  className="w-full py-3 pl-11 pr-11 rounded-xl glass-input text-sm placeholder-slate-500 outline-none"
                />
                <button
                  type="button"
              ...
              {password && (
                <div className="mt-2.5 p-2.5 rounded-xl bg-slate-900/60 border border-slate-800 space-y-1.5 animate-fadeIn">
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-slate-400 font-medium">Password Score & Strength:</span>
            ...
            <div className="flex items-center">
              <label className="flex items-center gap-2.5 cursor-pointer text-xs text-slate-300">
                <input
                  ...
                  className="w-4 h-4 rounded border-slate-700 bg-slate-800/80 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 transition-colors"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="relative w-full py-3.5 px-4 rounded-xl font-semibold text-white text-sm shadow-md shadow-blue-500/25 bg-blue-600 hover:bg-blue-700 transition-all duration-200 transform active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70"
            >
              {isLoading ? (
                <>
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0f172a] px-3 text-slate-400 tracking-wider font-medium">
                Or fast-track via corporate SSO
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="flex items-center justify-center py-2.5 px-3 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/70 hover:border-slate-600 text-slate-200 transition-all text-xs font-semibold cursor-pointer"
            >
              Google
            </button>
